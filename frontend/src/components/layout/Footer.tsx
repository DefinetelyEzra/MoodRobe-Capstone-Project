            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="md:col-span-1">
                        <h3 className="text-2xl font-bold mb-4 text-teal-400">Moodrobe</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-slate-300 text-sm">
                            ...
                            <li>
                                <a href="#returns" className="hover:text-teal-400 transition-colors">
                                    Returns
                                </a>
                            </li>
                            <li>
                ...
                <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="flex flex-wrap justify-center gap-6">
                        ...
                        <a href="#terms" className="text-slate-400 hover:text-teal-400 transition-colors text-sm">
                            Terms of Service
                        </a>
                        <a href="#cookies" className="text-slate-400 hover:text-teal-400 transition-colors text-sm">
                            Cookie Policy
                        </a>
                    </div>
                </div>
